...
var LasPriceAnimationMode;
(function (LasPriceAnimationMode) {
    LasPriceAnimationMode[LasPriceAnimationMode["Disabled"] = 0] = "Disabled";
    LasPriceAnimationMode[LasPriceAnimationMode["Continuous"] = 1] = "Continuous";
    LasPriceAnimationMode[LasPriceAnimationMode["OnDataUpdate"] = 2] = "OnDataUpdate";
})(LasPriceAnimationMode || (LasPriceAnimationMode = {}));
    ...
    TimeScale.prototype._internal_marks = function () {
        ...
        for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
            ...
            if (this._private__barSpacing > (maxLabelWidth / 2)) {
                ...
                label._internal_needAlignCoordinate = this._private__options.fixLeftEdge && tm._internal_index <= earliestIndexOfSecondLabel || this._private__options.fixRightEdge && tm._internal_index >= indexOfSecondLastLabel;
            }
            targetIndex++;
        }
...
var SeriesLastPriceAnimationPaneView = /** @class */ (function () {
    ...
    SeriesLastPriceAnimationPaneView.prototype._internal_update = function (updateType) {
        this._private__invalidated = true;
        if (updateType === 'data') {
    ...
    SeriesLastPriceAnimationPaneView.prototype._private__updateImpl = function (height, width) {
        ...
        var lastValue = this._private__series._internal_lastValueData(true, true);
...
var Series = /** @class */ (function (_super) {
    ...
    Series.prototype._internal_updateData = function (data, clearData) {
        ...
        (_a = this._private__lastPriceAnimationPaneView) === null || _a === void 0 ? void 0 : _a._internal_update('data');
...
export { ColorType, CrosshairMode, LasPriceAnimationMode, LineStyle, LineType, PriceLineSource, PriceScaleMode, TickMarkType, createChart, isBusinessDay, isUTCTimestamp, version };
